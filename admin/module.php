						...
						<fieldset>
								...
								<table id="demand">
									<dl>
										...
										<dd>
											<input type="text" name="categorie" size="54" class="alpha" maxlength="256" value="<?php echo $categorie;?>" required/>
										</dd>
									</dl>
									<dl>
										<dt>
										...
										<dd>
											<input type="text" name="module" class="alpha" size="54" maxlength="256" value=" <?php echo $module;?>" required/>
										</dd>
									</dl>
									<dl>
										<dt>	
