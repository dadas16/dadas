...
<div class="form">
         <form method="post" action="" class="niceform">
						...
						<option value='entreprise'>Entreprise qui</option>
		...
		<?php
			...
			{
				if($critere == "formation")
					echo"Le module le plus demandé est ".$ref." avec un nombre de fois de =".$max." par ".$champ." '"	;

				else	
					echo"L'entreprise qui a demandé le plus de formation est".$ref." avec un nombre de fois de =".$max." par ".$champ." '"	;
