...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a href="presence.php">Gérer Présence</a></li>
   ...
   <thead>
	...
	while($data=mysql_fetch_assoc($resultat)){
    	...
    	<tr id=".$id.">
            ...
            ?><td><div onClick="window.open('certificat.php?id=<? echo $id;?>','','width=1000, height=650,left=100,top=(0, toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no');" ><img src="images/user_edit.png" alt="Certificat" title="Générer Certificat"  /></div></td><?
...
<!--<script>
	...
	<!-- <a href="participant.php" class="bt_green"><span class="bt_green_lft"></span><strong>Add new item</strong><span class="bt_green_r"></span></a>
